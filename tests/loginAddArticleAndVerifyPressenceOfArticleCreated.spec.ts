...
test.describe('Create Article, verify presence, navigate to favorite posts and delete article', () => {
    ...
    test('create article, check presence of article title, navigate to favorite posts and delete article created', async ({ page, request }) => {
        ...
        const deleteArticleResponse = await request.delete('https://conduit-api.bondaracademy.com/api/articles/cerno-sponte-theologus-38023')
